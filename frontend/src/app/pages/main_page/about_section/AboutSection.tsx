  ...
  return (
    <section id="section_sobre" className={styles.section}>
      ...
      <div className={styles.image_cont}>
        <MyButton classNm={null} link="#">Conheça nossa história</MyButton>
      </div>
      ...
      <MyButton classNm={styles.mybtn} link="/catalog">Acessar Catálogo</MyButton>
      </div>
      <h3>Algo mais?</h3>
      <p>Para orçamentos, dúvidas, parcerias e etc. Entre em contato conosco através do nosso <a href="">Instagram</a> ou se preferir, acesse nossa <Link href="/contact">Página de Contato</Link>.</p>
      <div>
      </div>
    </section>
  );
